...
导入同时兼容 `research-cultivation-personalization-v1` 至 `v4`。安全升级会迁移 `storage/profile/`，因此头像不会因版本更新丢失。

## 10. 山门首页、检索与闭关

- 首页默认隐藏侧边栏，只提供一个开始修炼主动作，以及修炼记录、温故知新、入定闭关和知识库四个大入口；
