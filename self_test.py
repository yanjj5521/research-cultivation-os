...
def main() -> None:
    ...
    for marker in (
        'data-nav-item="literature_report"',
        'data-nav-item="workbench"',
        'data-nav-item="library"',
        'data-nav-item="online"',
    ):
        if marker not in daily_navigation.text:
            failures.append(f"learning-first navigation missed: {marker}")
